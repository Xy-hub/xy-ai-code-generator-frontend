...
// 使用指定参数获取数据
const fetchDataWithParams = async (params: API.AppQueryRequest) => {
  try {
...
const doSearch = () => {
  ...
  // 创建请求参数副本，如果生成类型为"全部"（空值），则不传递该参数
  const requestParams = { ...searchParams }
  if (requestParams.codeGenType === '') {
    requestParams.codeGenType = undefined
  }
